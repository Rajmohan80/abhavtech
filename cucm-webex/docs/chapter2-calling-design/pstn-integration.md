...
!!! info "Working Document -- Not Yet Finalised"
    ...
    **Pending confirmation:**
    - Actual DID ranges per city from Tata/Airtel (India LGW sites)
    - Port vs retain decisions for EMEA and Americas numbers
    - Final toll-free number assignments
    - Number porting timeline aligned with site migration waves
